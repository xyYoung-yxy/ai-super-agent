...
/**
 * 处理工具调用的基础代理类，具体实现了 think和 act方法，可以用作创建示例的父类
 */
...
public class ToolCallAgent extends ReActAgent{
    ...
    public ToolCallAgent(ToolCallback[] availableTools, SseConnectionManager sseConnectionManager){
    ...
    public String act() {
        ...
        String results = toolResponseMessage.getResponses().stream()
                .map(toolResponse -> "工具" + toolResponse.name() + "的返回结果：" + toolResponse.responseData())
                .collect(Collectors.joining("\n"));
        log.info(results);
        return results;
    }
